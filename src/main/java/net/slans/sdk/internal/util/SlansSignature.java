...
import net.slans.sdk.internal.util.Asymmetric.AsymmetricManager;
import net.slans.sdk.internal.util.Asymmetric.RSAEncryptor;
...
public class SlansSignature {
    ...
    public static String encryptAndSign(String bizContent, String alipayPublicKey,
                                        ...
                                        boolean isSign, String signType) throws SlansApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = SlansConstants.CHARSET_GBK;
        }
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
                                             ...
                                             boolean isDecrypt, String signType) throws SlansApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
            if (!verifyV2(params, alipayPublicKey, charset, signType)) {
                throw new SlansApiException("rsaCheck failure:rsaParams=" + params);
            }
        }
    ...
    public static Map<String, String> getSortedMap(RequestParametersHolder requestHolder) {
        ...
        SlansHashMap appParams = requestHolder.getApplicationParams();
        if (appParams != null && appParams.size() > 0) {
            sortedParams.putAll(appParams);
        }
        SlansHashMap protocalMustParams = requestHolder.getProtocalMustParams();
        if (protocalMustParams != null && protocalMustParams.size() > 0) {
            sortedParams.putAll(protocalMustParams);
        }
        SlansHashMap protocalOptParams = requestHolder.getProtocalOptParams();
    ...
    public static String rsa256Sign(String content, String privateKey,
                                    String charset) throws SlansApiException {
    ...
    public static String checkSignAndDecrypt(Map<String, String> params, String alipayPublicKey,
                                             String cusPrivateKey, boolean isCheckSign,
                                             boolean isDecrypt) throws SlansApiException {
        String charset = params.get("charset");
        String bizContent = params.get("biz_content");
        if (isCheckSign) {
    ...
    public static String encryptAndSign(String bizContent, String alipayPublicKey,
                                        String cusPrivateKey, String charset, boolean isEncrypt,
                                        boolean isSign) throws SlansApiException {
        StringBuilder sb = new StringBuilder();
        if (StringUtils.isEmpty(charset)) {
            charset = SlansConstants.CHARSET_GBK;
        }
     ...
     * @throws SlansApiException
     */
    public static String getCertSN(String certPath) throws SlansApiException {
     ...
     * @throws SlansApiException
     */
    public static String getAlipayPublicKey(String alipayPublicCertPath) throws SlansApiException {
