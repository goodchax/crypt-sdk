...
public class SM2Encryptor extends BaseAsymmetricEncryptor {
    ...
    @Override
    protected String doDecrypt(String cipherTextBase64, String charset, String privateKey) throws SlansApiException {
        //加载私钥参数
    ...
    @Override
    protected String doEncrypt(String plainText, String charset, String publicKey) throws SlansApiException, UnsupportedEncodingException {
        // 解析PKCS8格式SM2私钥
    ...
    @Override
    protected String doSign(String content, String charset, String privateKey) throws SlansApiException, UnsupportedEncodingException {
        byte[] privateKeyByte = base64.decode(privateKey);
        PrivateKey sm2PrivateKey = parsePKCS8PrivateKey(privateKeyByte);
    ...
    @Override
    protected boolean doVerify(String content, String charset, String publicKey, String sign) throws SlansApiException, UnsupportedEncodingException {
        // 使用SM2公钥验签
        ...
        if (!valid) {
            throw new SlansApiException("验签失败");
        }
        return valid;
    }
